...
const cssPrefix: string = 'st-select-item';
const SelectItem: FC<SelectItemProps> = ({
  ...
  const isActive: boolean = multiple ? actualValue.indexOf(value) > -1 : value === actualValue;
  ...
  const handleClick = (e: React.MouseEvent): void => {
    ...
    if (multiple) {
      ...
      updateActualValue && updateActualValue(copyActualValue);
    } else {
      updateActualValue && updateActualValue(value);
    }
